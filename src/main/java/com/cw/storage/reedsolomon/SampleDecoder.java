...
//            return;
//        }
        final File originalFile = new File("text.txt");
        ...
        for (int i = 0; i < TOTAL_SHARDS; i++) {
            ...
            if (shardFile.exists()) {
                ...
                shardPresent[i] = true;
                shardCount += 1;
                InputStream in = Files.newInputStream(shardFile.toPath());
        ...
        OutputStream out = Files.newOutputStream(decodedFile.toPath());
